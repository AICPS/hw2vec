...
scripts for generating datasets.
    ...
    for generating Netlist dataset
        ...
        self.parser.add_argument('--raw_dataset_path', type=str, default='../../data_graphs/data_ready_FIXED/', help="Path to raw dataset for parsing if no precache.")
        self.parser.add_argument('--precache_path', type=str, default='./dataset.pkl', help="Path to hardware graphs for parsing.")
