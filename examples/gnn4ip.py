...
class Config:
    ...
    def __init__(self, args):
        self.parser = ArgumentParser(description="", formatter_class=RawTextHelpFormatter)
        ...
        self.parser.add_argument('--pkl_path', type=str, default='./dataset_rtl.pkl', help="Path to hardware graphs for parsing.")
...
if __name__ == "__main__":
    ''' scripts for running gnn4ip: 
        => python gnntip.py --raw_dataset_path ../data/IP-datasets/data_DFG/ --pkl_path dataset_rtl.pkl --dataset_name RTL
    ...
    if cfg.pkl_path.exists() is False:
        ...
        parser = GraphParser_IP(cfg.raw_dataset_path)
